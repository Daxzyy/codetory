...
async function ssyoutube(url, resolusi = '720') {
  if (!quality.includes(resolusi)) {
    throw new Error(\`Invalid quality. Choose: \${quality.join(', ')}\`)
  }
  ...
  if (resolusi === 'audio') {
    ...
    const finalDownloadUrl = proxyJson.success && proxyJson.data ? proxyJson.data.proxiedUrl : audioJson.data.url
  ...
  const proxyJson = await proxyreq.json()
  const finalDownloadUrl = proxyJson.success && proxyJson.data ? proxyJson.data.proxiedUrl : m3u8Url
...
/*
{
  ...
  thumbnail: 'https://i.ytimg.com/vi/gvunApwKIiY/mqdefault.jpg?v=6808a86f',
  duration: '00:03:19',
  resolusi: 'audio',
  downloadUrl: 'https://ex.fastcarrycdn.online/RUcBARAMAAAAAEJ5z91llkAAwhxDDZ4yaPtxBFNRAjk4QvewUY9T2GAT1ZPEoJ9BYCBizpH2wCK0xE5CQIArHxtkjzolPGvHfSYFKSnqXgNe4z19D14VLZYS7POXwuCkkkEH7aYKRS8RBDihR5MCE62Ii7vWql88MLh_AbLRO6iOe_Y8tGyqgXWypeskOA0tkOa5rxMGWxYQwTvtmBIUa8UYPIxIqKELak59McSVoIGgn1uHTWbIy08eR0crstU9sJLkeGpz62dnp7BIDnX8RsvnfeRDL-DCOgrzowSVCWazsl2R6gcklzYjbngfYSxQt38HLkkLVu60KpWkMVOIvAiNFbviKDWwpMUSiBVvuOmct9ZAW9oxTZc'
}
*/